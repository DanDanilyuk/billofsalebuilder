...
function partyFields(prefix, opts = {}) {
  ...
  fields.push(
    ...
    { path: `${prefix}.street2`, label: p.street2.label, req: !!p.street2.req, kind: 'text', showWhen: notSkipped },
    { path: `${prefix}.zip`,     label: p.zip.label,     req: !!p.zip.req,     kind: 'text', hint: p.zip.hint, validate: ['zip'], showWhen: notSkipped },
  ...
  fields.push(
    ...
    { path: `${prefix}.coOwner.street2`, label: p.coOwnerStreet2.label, req: false, kind: 'text', showWhen: showsCoOwnerAddress },
    { path: `${prefix}.coOwner.zip`,     label: p.coOwnerZip.label,     req: false, kind: 'text', hint: p.zip.hint, validate: ['zip'], showWhen: showsCoOwnerAddress },
